...
public class ProductoRepository {
   ...
   public List<ProductoEntity> findAllOfert()
   {
	   ...
	   for(ProductoEntity listaDeProduct: listaDeProductos){
			if(listaDeProduct.getEstado().equals("Oferta")){
   ...
   public ProductoEntity findById(Integer codigo)
   {
	...
	{
		ProductoEntity objProducto1= new ProductoEntity(1, "Cama", "Sin ofertar", 800000);
		this.listaDeProductos.add(objProducto1);
		ProductoEntity objProducto2= new ProductoEntity(2, "Espejo", "Sin ofertar", 120000);
		this.listaDeProductos.add(objProducto2);
		ProductoEntity objProducto3= new ProductoEntity(3, "Silla", "Sin ofertar", 600000);
		this.listaDeProductos.add(objProducto3);
		ProductoEntity objProducto= new ProductoEntity(4, "Tv 50 pulg", "Oferta", 1800000);
